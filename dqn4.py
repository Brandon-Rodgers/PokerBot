...
MODEL_NAME = '3x256_Bot4' # For model save
MIN_REWARD = 100  
...
class DQNAgent:
	...
	def train(self, terminal_state):
		...
		self.model.fit(x=np.array(X)/10_000, y=np.array(y), batch_size = MINIBATCH_SIZE, epochs=1, verbose=0, shuffle=True, callbacks=[self.tensorboard] if terminal_state else None)
