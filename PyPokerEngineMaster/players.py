class BasePokerPlayer(object):
  ...
  def respond_to_ask(self, message):
    ...
    valid_actions, hole_card, round_state, player_id = self.__parse_ask_message(message)
    return self.declare_action(valid_actions, hole_card, round_state, player_id)
  ...
  def __parse_ask_message(self, message):
    ...
    return valid_actions, hole_card, round_state, player_id
